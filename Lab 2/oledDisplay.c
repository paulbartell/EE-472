...
void oledDisplay(void* taskDataPtr)
{
  if(globaltime % MAJORCYCLECOUNT == 0)
  {
    ...
    RIT128x96x4StringDraw(CLEAR, 10, 8, 15); 
    ...
    RIT128x96x4StringDraw(CLEAR, 10, 24, 15); 
    ...
    RIT128x96x4StringDraw(CLEAR, 10, 40, 15);
    ...
    RIT128x96x4StringDraw(CLEAR, 10, 56, 15);   
    ...
    RIT128x96x4StringDraw(CLEAR, 10, 72, 15);
